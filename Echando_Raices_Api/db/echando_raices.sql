...
-- Table reforestacion
-- -----------------------------------------------------
DROP TABLE IF EXISTS reforestacion;
CREATE TABLE IF NOT EXISTS reforestacion (
  idreforestacion INT NOT NULL AUTO_INCREMENT,
